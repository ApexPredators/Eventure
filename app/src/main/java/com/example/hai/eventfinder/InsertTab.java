 ...
 */
public class InsertTab extends Fragment {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAM_START_REQUEST && resultCode == RESULT_OK){
            ...
            try{
                ...
                //TODO: API doesn't currently support location for build version on site even though repo has latest feature
                Event apexEvent = Apex.nlp("en", wordList.toString());  //might have to reparse
                eventName.setText(apexEvent.title());
